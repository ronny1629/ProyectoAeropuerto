...
namespace SistemaAeropuerto.Controllers
{
    public class avionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_avion,tipo,siglas,capacidad,fecha_registro")] avion avion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_avion,tipo,siglas,capacidad,fecha_registro")] avion avion)
        {
            if (ModelState.IsValid)
            {
